...
export default function Button({
  ...
  const sizeStyles = {
    ...
    lg: "px-7 py-3.5 md:py-4 text-base rounded-2xl gap-2.5",
  };
  ...
  const variantStyles = {
    ...
    secondary:
      "bg-navy-900 hover:bg-navy-950 text-white shadow-md border border-brand/20 active:scale-[0.98]",
    outline:
    ...
    gold:
      "bg-accent-gold hover:bg-accent-goldHover text-slate-900 shadow-md font-bold active:scale-[0.98]",
    whatsapp:
  ...
  return (
    <button disabled={disabled || loading} className={combinedClasses} {...props}>
      {content}
    </button>
  );
}
