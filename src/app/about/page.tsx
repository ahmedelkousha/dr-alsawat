  ...
  return (
    <div className="space-y-12 md:space-y-20 pb-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 md:space-y-24">
        ...
        <section className="bg-gradient-to-r from-brand-900 to-brand-950 text-white rounded-3xl p-8 md:p-10 shadow-xl text-center space-y-4">
          <span className="text-xs font-bold text-accent-gold uppercase tracking-widest">
            {doctorData.taglineHeader}
          </span>
          <h2 className="text-base md:text-xl font-bold max-w-3xl mx-auto">
            {doctorData.taglineContent}
          </h2>
          <div className="pt-2 flex justify-center gap-4">
            <Link
              href="/appointments"
              className="bg-brand-500 hover:bg-brand-400 text-white font-bold text-sm px-6 py-3.5 rounded-xl shadow transition-all"
            >
              حجز موعد استشارة
            </Link>
          </div>
